...
import { MultiCompiler, type MultiCompilerOptions, type MultiRspackOptions } from './MultiCompiler'
...
function createMultiCompiler(options: MultiRspackOptions): MultiCompiler {
  ...
  const compiler = new MultiCompiler(compilers, options as MultiCompilerOptions)
...
function rspack(options: MultiRspackOptions | RspackOptions): MultiCompiler | Compiler
function rspack(options: MultiRspackOptions, callback?: Callback<Error, MultiStats>): null | MultiCompiler
function rspack(options: RspackOptions, callback?: Callback<Error, Stats>): null | Compiler
function rspack(
